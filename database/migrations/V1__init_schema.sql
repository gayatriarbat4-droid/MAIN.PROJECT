...
BEGIN
    CREATE TABLE appointments (
        ...
        time_slot NVARCHAR(50) NOT NULL,
        status NVARCHAR(50) NOT NULL DEFAULT 'CONFIRMED', -- CONFIRMED, RESCHEDULED, COMPLETED, CANCELLED
        consultation_type NVARCHAR(50) NOT NULL DEFAULT 'IN_CLINIC', -- IN_CLINIC, TELEHEALTH
...
BEGIN
    CREATE TABLE medical_records (
        id BIGINT IDENTITY(1,1) PRIMARY KEY,
        patient_id BIGINT NOT NULL,
        record_type NVARCHAR(100) NOT NULL, -- LAB_REPORT, DIAGNOSTIC, DISCHARGE, PRESCRIPTION
...
BEGIN
    CREATE TABLE emergency_requests (
        ...
        status NVARCHAR(50) NOT NULL DEFAULT 'DISPATCHED', -- PENDING, DISPATCHED, EN_ROUTE, ARRIVED, RESOLVED
